...
<body>
    ...
    <script>
        ...
        function openRepoUpload() {{
            const url = 'https://github.com/' + REPO_OWNER + '/' + REPO_NAME + '/upload/main';
            window.open(url, '_blank');
            showToast('📂 Repository upload page opened — drop your file there to save it.', 'info');
        }}
        ...
        function handleUpload(input) {{
            ...
            // Open GitHub upload page for direct repo upload
            openRepoUpload();
